...
def generate_report_t1v11(data, codebook_path, outputPath, respondentID):
    ...
    print("T1_v1.1-rapport generert for " + str(respondentID) + " (" + data["fnr"][0:6] + " " + data["fnr"][6:] + ") " + comment)
