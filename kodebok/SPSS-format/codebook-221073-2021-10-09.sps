* Encoding: UTF-8.
* SSHF Fysikalsk medisinsk kartlegging (id 221073) - 09.10.2021 20:38
...
*overbelastning.
VARIABLE LABELS overbelastning 'Opplever du overbelastning/stress i en slik grad at det påvirker deg negativt i dagliglivet?'.
VALUE LABELS overbelastning
  ja 'Ja'
  nei 'Nei'.
